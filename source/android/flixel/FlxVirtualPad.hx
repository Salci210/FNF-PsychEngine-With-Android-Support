	...
	public function new(DPad:FlxDPadMode, Action:FlxActionMode)
	{
		...
		switch (DPad)
		{
			...
			case UP_LEFT_RIGHT:
				...
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 135, 132, 127, 'left', FlxColor.PURPLE)));
			...
			case RIGHT_FULL:
				dPad.add(add(buttonUp = createButton(FlxG.width - 258, FlxG.height - 366, 132, 127, 'up', FlxColor.LIME)));
			...
			case DUO:
				...
				dPad.add(add(buttonUp2 = createButton(FlxG.width - 258, FlxG.height - 366, 132, 127, 'up', FlxColor.LIME)));
